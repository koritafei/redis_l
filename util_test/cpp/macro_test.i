...
# 26 "macro_test.c"
static inline size_t atomic_load_zu() {
  printf("%d %s\n", 26, __func__);
}
static inline size_t atomic_fetch_add_zu() {
  printf("%d %s\n", 26, __func__);
}
static inline unsigned atomic_load_u() {
  printf("%d %s\n", 27, __func__);
}
static inline unsigned atomic_fetch_add_u() {
  printf("%d %s\n", 27, __func__);
}
# 74 "macro_test.c"
struct tsd_s {
